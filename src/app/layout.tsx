  ...
  return (
    <html lang="pt-BR">
      <body className={`${inter.variable} ${playfair.variable} font-sans min-h-screen flex flex-col`}>
        ...
        <header className="w-full bg-[#2d2d2d] border-t-4 border-b border-gray-700 py-10 px-6 md:px-12 text-center relative shadow-sm">
          <div className="absolute right-6 md:right-12 top-1/2 transform -translate-y-1/2 z-10">
            <LoginButton />
          </div>
          <h1 className="font-playfair text-4xl md:text-5xl font-bold text-[#ff5252] tracking-tight mb-2">
        ...
        {/* RODAPÉ */}
        <footer className="w-full bg-[#2d2d2d] border-t border-gray-700 py-8 text-center text-sm text-gray-400 mt-auto">
